      pipeline {
        ...
        post {
           success {
                ...
                discordSend description: 'The pipeline ${BUILD_DISPLAY_NAME} completed successfully.', footer: '', image: '', link: '', result: '', scmWebUrl: '', thumbnail: '', title: 'Pipeline succeeded: ${BUILD_DISPLAY_NAME}', webhookURL: 'https://discord.com/api/webhooks/1132648511058497556/8yRNdxJ_9jY4-QDZIbotxpufmbzvgTf9MZSm0OUSgid9ri72yfPtQ-NFLDEo7LECbRC9'
            }
          }
        }